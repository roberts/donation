...
require_once __DIR__ . '/../stripesecret/vendor/autoload.php';
use Symfony\Component\Dotenv\Dotenv;
$dotenv = new Dotenv();
$dotenv->load('/.env');

// Parse Symfony DATABASE_URL format and convert to ArrestDB format
...
ArrestDB::Serve('GET', '/(#any)/(#any)/(#any)', function ($table, $id, $data)
{
	$query = array
	(
		sprintf('SELECT ibe_id as value, name as label FROM "%s"', $table),
